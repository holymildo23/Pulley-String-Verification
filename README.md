...
- experimental_data.csv : experimental measurements
- tension_distribution.py : simulation of tension distribution using the Capstan equation
- non_slipping_condition.py : parameter-space analysis of the non-slipping condition
- figures/ : generated plots used in the report and presentation
